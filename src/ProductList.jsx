    ...
    const plantsArray = [
        {
            ...
            plants: [
                ...
                { name: "Rubber Plant", image: "https://cdn.pixabay.com/photo/2020/02/15/11/49/flower-4850729_1280.jpg", description: "Easy to care for and effective at removing indoor toxins.", cost: "$17" },
        ...
        },
        {
            ...
            plants: [
                ...
                { name: "Citronella", image: "https://images.unsplash.com/photo-1592729645009-b96d1e63d14b?q=80&w=1170&auto=format&fit=crop", description: "Citronella plants are well known for repelling mosquitos.", cost: "$25" },
                { name: "Catnip", image: "https://cdn.pixabay.com/photo/2015/07/02/21/55/cat-829681_1280.jpg", description: "Attracts cats but repels mosquitos.", cost: "$11" }
            ]
        }
    ];
    ...
    return (
        <div>
            <div className="navbar">
                <a href="#" onClick={() => setShowCart(false)}>Home / Plants</a>
